...
public class InsuranceFilter {
	public static String Filter(Record record) {
		...
		if(record.getAdditionalInfo()!=null) {
			if(insurance.equalsIgnoreCase(InsuranceType.PRIVATE_UNKNOWN) && record.getAdditionalInfo().startsWith("ERX") && !insurance.equalsIgnoreCase(InsuranceType.MEDICARE_TELMED))
