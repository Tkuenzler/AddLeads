		...
		switch(record.getPcn()) {
			...
			case "MEDDAET":
			{
				if(record.getPolicyId()!=null) {
					if(record.getPolicyId().startsWith("ME"))
			...
			case "MEDDADV":
			{
				...
				if(record.getGrp().equalsIgnoreCase("HMOMAPD"))
					return InsuranceType.MAPD_HMO;
				else if(record.getGrp().startsWith("RX88"))
					return InsuranceType.MEDICARE_COMMERCIAL;
				else if(record.getGrp().startsWith("RX")) {
					return checkRXNumber(record);
				}
				else 
					return InsuranceType.MEDICARE_COMMERCIAL;
			}
			...
			case "00670000":
				...
				default: return InsuranceType.UNKNOWN_PBM;
		}
	}
